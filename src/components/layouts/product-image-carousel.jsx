      ...
      <div ref={emblaRef} className="overflow-hidden">
        ...
        >
          {images.map((image, index) => (
            <div
              className="relative aspect-square min-w-0 flex-[0_0_100%] pl-4  flex justify-center items-center "
              key={index}
            >
              <div className="absolute inset-0 z-10 bg-zinc-950/5 group-hover:bg-zinc-950/40" />
              <img
